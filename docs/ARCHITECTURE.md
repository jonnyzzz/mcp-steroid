...
- Kotlin compilation: bundled Kotlin Build Tools implementation jars (`kotlinc/` in the plugin dist), driven via the Build Tools API in an isolated classloader (in-process or Kotlin daemon).
