...
object CommonToolParams {
     ...
     * MCP-required, but CLI-optional (`cliOptional`): the devrig CLI infers it from the current
     * directory when omitted (issue #266), so its generated help renders `--project_name` as optional.
     */
    fun projectName() =
