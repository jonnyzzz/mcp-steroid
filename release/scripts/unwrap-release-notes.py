...
and NEVER touches content inside code fences (``` or ~~~), headings, table
rows, horizontal rules, HTML blocks, or blank lines. A line that starts a new
block (heading, list marker, table row, HR, HTML, fence, blockquote after
...
def unwrap(text):
    ...
    for line in text.splitlines():
        ...
        # (not blank, heading, table, blockquote, HR, or fence) and the current
        # line does not start a new block.
